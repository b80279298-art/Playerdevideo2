...
object OfflinePlaybackHelper {
    ...
    fun playUri(activity: Activity, uri: Uri) {
        // http/https URIs are network streams — route them through playLink/LinkGenerator,
        // which tries extractors and falls back to a direct ExtractorLink.
        // DownloadFileGenerator (the default below) is designed for local files and
        // does not work correctly for remote streams.
